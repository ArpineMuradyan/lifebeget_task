        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <input type="hidden" id="user_role" name="quotation" value="{{ Auth::user()->roles_id}}">
                    <input type="hidden" id="product_attribute" value="{{ $product->attributes}}">
                    <input type="hidden" id="product_id" value="{{ $product->id}}">
                    <div class="card-body">
                        <form method="post">
                            @csrf
                            <img id="product_photo" class="m-auto" width="400px" height="400px" photo_name="{{$product->photo}}" src="{{ asset('images/products/'. $product->photo) }}" alt="">
                            <div class="form-group row mt-2">
                                <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Name') }}</label>

                                <div class="col-md-6">
                                    <input value="{{$product->name}}" id="name" type="text" @if(Auth::user()->roles_id!=1) disabled @endif class="form-control @if(session()->get('error') && session()->get('error')->name) is-invalid @endif" name="name" required autocomplete="name" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea @if(Auth::user()->roles_id!=1) disabled @endif id="description" class="form-control @if(session()->get('error') && session()->get('error')->description) is-invalid @endif" name="description" required autocomplete="description">{{$product->description}}</textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="photo" type="file" @if(Auth::user()->roles_id!=1) disabled @endif class="form-control @if(session()->get('error') && session()->get('error')->photo) is-invalid @endif" name="photo" required autocomplete="photo" autofocus>
                            ...
                            <div class="form-group row mt-2">
                                ...
                                <div class="col-md-6">
                                    <select name="category_id" @if(Auth::user()->roles_id!=1) disabled @endif id="category_id" class="form-control @if(session()->get('error') && session()->get('error')->category_id) is-invalid @endif">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input value="{{$product->meta_title}}" id="meta_title" type="text" class="form-control @if(session()->get('error') && session()->get('error')->meta_title) is-invalid @endif" name="meta_title" required autocomplete="meta_title" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="meta_description" type="meta_description" class="form-control @if(session()->get('error') && session()->get('error')->meta_description) is-invalid @endif" name="meta_description" required autocomplete="meta_description">{{$product->meta_description}}</textarea>
