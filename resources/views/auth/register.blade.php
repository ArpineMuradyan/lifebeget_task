                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('registration') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input  class="form-control @error('confirm_password') is-invalid @enderror" id="confirm_password" type="password" name="confirm_password" required autocomplete="new-password">
