...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container mt-10">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header"><?php echo e(__('Create')); ?></div>
...
$message = $__bag->first($__errorArgs[0]); ?>
                                        <div class="alert text-danger mb-0 p-0"><?php echo e($message); ?></div>
                                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="description" type="description" class="form-control <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="description" required autocomplete="description"></textarea>
...
unset($__errorArgs, $__bag); ?>" name="photo" required autocomplete="photo" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="color" required autocomplete="color" autofocus>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group row mt-1 price_input_box">
                                            ...
                                            <div class="col-md-6">
                                                <input id="price" type="number" class="appearance-none form-control <?php $__errorArgs = ['price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="meta_title" required autocomplete="meta_title" autofocus>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="meta_description" type="meta_description" class="form-control <?php $__errorArgs = ['meta_description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="meta_description" required autocomplete="meta_description"></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/lifebeget/resources/views/admin/product/add.blade.php ENDPATH**/ ?>